...
for two years without operator intervention. The Linux operating system provides contiunous network
...
or, preferably, records a single data frame when called 
