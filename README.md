...
for two years without user intervention. The Linux operating system provided continous network
access to the collected data. The aim of this script is to provide a robust function with a minimum amount of code.
